...
class TestWebSocketSessionLogs:
    ...
    def test_websocket_connect_and_receive_log(self):
        ...
        with client.websocket_connect(f"/ws/sessions/{session_id}/logs"):
    ...
    def test_websocket_disconnect_unsubscribes(self):
        ...
        assert (
            session_id not in broadcaster._subscribers
            or len(broadcaster._subscribers.get(session_id, set())) == 0
        )
    ...
    def test_websocket_multiple_sessions(self):
        ...
        with client.websocket_connect("/ws/sessions/session-a/logs"):
            with client.websocket_connect("/ws/sessions/session-b/logs"):
