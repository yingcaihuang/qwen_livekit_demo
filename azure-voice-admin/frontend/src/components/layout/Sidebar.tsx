...
import { LayoutDashboard, Server, History, Users, Shield, Settings, LogOut, KeyRound, ScrollText, Activity } from 'lucide-react'
...
const adminItems: NavItem[] = [
  ...
  { label: '系统监控', path: '/admin/monitor', icon: Activity, capability: 'audit:read' },
]
