        ...
        {instance && (
          <div className="flex items-center gap-2 rounded-lg border bg-card px-3 py-2 shadow-sm">
            ...
            <div className="min-w-0">
              ...
              {selectedModel && (
                <div className="mt-0.5 inline-flex items-center gap-1 rounded-md bg-emerald-50 px-1.5 py-0.5 font-mono text-[11px] font-medium text-emerald-700 dark:bg-emerald-950/40 dark:text-emerald-300">
